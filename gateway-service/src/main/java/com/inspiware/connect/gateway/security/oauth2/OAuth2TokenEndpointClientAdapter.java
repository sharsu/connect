...
public abstract class OAuth2TokenEndpointClientAdapter implements OAuth2TokenEndpointClient {
    ...
    public OAuth2TokenEndpointClientAdapter(RestTemplate restTemplate, OAuth2Properties oAuth2Properties, ServiceProperties serviceProperties) {
    ...
    protected String getTokenEndpoint() {
        String tokenEndpointUrl = serviceProperties.getSecurity().getClientAuthorization().getAccessTokenUri();
