package com.inspiware.connect.gateway.configuration.oauth2;

import com.inspiware.connect.gateway.security.oauth2.CookieTokenExtractor;
import com.inspiware.connect.gateway.security.oauth2.OAuth2AuthenticationService;
import com.inspiware.connect.gateway.security.oauth2.OAuth2CookieHelper;
import com.inspiware.connect.gateway.security.oauth2.OAuth2TokenEndpointClient;
import com.inspiware.connect.gateway.web.filter.RefreshTokenFilterConfigurer;
...
public class OAuth2AuthenticationConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public OAuth2AuthenticationConfiguration(OAuth2Properties oAuth2Properties, OAuth2TokenEndpointClient tokenEndpointClient, TokenStore tokenStore, PasswordEncoder passwordEncoder) {
    ...
    public OAuth2AuthenticationService uaaAuthenticationService() {
        return new OAuth2AuthenticationService(tokenEndpointClient, cookieHelper(), passwordEncoder);
    }
